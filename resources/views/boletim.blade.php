...
<div class="pt-8 max-w-6xl mx-auto px-8 lg:px-4">
    ...
    <div class="py-10 flex space-x-4">
                ...
                @guest
                    <div class="max-w-xl mx-auto">
                        ...
                        <div x-data='{modalSign:false}'>
                            ...
                            <div x-show='modalSign' class="fixed w-full h-screen bg-black bg-opacity-50 left-0 top-0 p-20" style="display: none;">
        ...
        @auth
            <div class="w-2/12">
                @foreach( $boletims as $edicao )
                    <div class="mb-8 border-b border-dotted border-gray-300 hover:bg-gray-50 p-2 @if( $edicao->id == $boletim->id ) bg-gray-100 text-actionblue @endif">
                        <a href="{{route('boletim',$edicao)}}">
                            <div class="font-bold">
                                {{$edicao->title}}
                            </div>
