...
<div class="pt-8 max-w-6xl mx-auto px-8 lg:px-0 hidden">
	...
	<div class="grid md:grid-cols-3 ks:grid-cols-2  xs:grid-cols-1 gap-10">

		@if( $newsCall = \App\Models\News::where('call',1)->first())
			<div class="sm:col-span-2 md:col-span-1">
				<a href="{{$newsCall->slug}}">
					<div class="h-60 w-full" style="background: url('{{asset('storage/'.$newsCall->cover)}}') no-repeat; background-size: cover ">
						@if( $newsCall->cover )
			    		@else
					...
					<div class="mt-2">
						<span class="text-center bg-red-600 rounded text-white px-2 text-sm">Notícias</span>
					</div>
					
					<div class="pt-2 font-bold text-2xl h-24 ">
						<p class="">
							<a href='{{$newsCall->slug}}'>{{$newsCall->title}}</a>
						</p>
					</div>
					...
					<div class="text-sm py-2 text-gray-500">
						{{ date('d/M/y',strtotime($newsCall->date))}} - <b class='text-black'>{{config('app.name')}}</b>
					</div>
				</a>
			</div>
		@endif
		@if( $newsCall = \App\Models\Video::where('call',1)->first())
			<div>
				<a href="{{$newsCall->slug}}">
					...
					<div class="mt-2">
						<span class="text-center bg-green-600 rounded text-white px-2 text-sm">Vídeos</span>
					</div>
					<div class="pt-4 font-bold text-2xl h-24 ">
						<p class="">{{$newsCall->title}}</p>
					</div>
					<div class="text-gray-500 h-20">
						{{$newsCall->short_text}}
					</div>
		...
		@if( $newsCall = \App\Models\Boletim::where('call',1)->first())
			<div>
				<a href="/boletim-ac-saude-{{$newsCall->id}}">
					<div class="h-60 w-full" style="background: url('{{asset('storage/'.$newsCall->cover)}}') no-repeat; background-size: cover ">
						@if( $newsCall->cover )
			    		@else
			    			<img src="data:image/png;base64," alt="" class="mx-auto"> 
					...
					<div class="mt-2">
						<span class="text-center bg-gray-600  rounded text-white px-2 text-sm">Boletim</span>
					</div>
					<div class="pt-4 font-bold text-2xl h-24 ">
						<p class="">{{$newsCall->title}}</p>
					</div>
...
<div class="max-w-6xl mx-auto py-10 px-8 lg:px-0">
	<div class="">
		<div>
			...
			<div class="grid md:grid-cols-2 xs:grid-cols-1 gap-10">
				@foreach(\App\Models\News::orderBy('created_at','desc')->get()->take(2) as $news )
					<div class="grid lg:grid-cols-2 xs:grid-cols-1 ">
						<div class="max-h-56 overflow-hidden">
							@if( $news->cover )
				    			<img src="{{asset('/storage/'.$news->cover)}}" alt="" class="w-full hover:scale-110 transform transition duration-300 ease-in-out " > 
				    		@else
				    			<img src="data:image/png;base64," alt="" class="mx-auto rounded"> 
				    		@endif
						</div>
						<div class="px-6 py-10 lg:py-0">
							<a href="{{$news->slug}}">
								<div class="font-bold text-2xl text-center line-clamp-2">{{ $news->title }}</div>
								<div class="text-sm py-4 text-gray-700 text-center">
		...
		<div class="mt-10">
			...
			@foreach(\App\Models\News::orderBy('created_at','desc')->get()->skip(2)->take(2) as $news )
				<div class="hover:bg-gray-50 py-4  border-b border-dashed border-gray-300 group">
					<a href='{{route("reading",["slug"=>$news->slug])}}' class="flex"> 	
						<div class="w-0 sm:w-20 py-1">
							@if( $news->cover )
				    			<img src="{{asset('/storage/'.$news->cover)}}" alt="" class="mx-auto rounded"> 
				    		@else
				    			<img src="data:image/png;base64," alt="" class="mx-auto rounded"> 
				    		@endif
						</div>
						<div class=" sm:px-4">
							...
							<p class="font-bold group-hover:text-actionblue transition">{{$news->title}}</p>
...
<div class="bg-gray-100 my-20 py-8 border-b-2 border-gray-300 w-full">
...
<div class="pt-8 max-w-6xl mx-auto  px-8 lg:px-0">
	...
	<div class="">
		...
		<div class="mt-10">
			...
			@foreach(\App\Models\Video::orderBy('created_at','desc')->get()->skip(2)->take(3) as $videos )
				<div class="hover:bg-gray-50 py-4  border-b border-dashed border-gray-300 group">
					<a href='{{route("reading",["slug"=>$videos->slug])}}' class="flex"> 	
						<div class="w-0 sm:w-20 py-1">
							@if( $videos->cover )
				    			<img src="{{asset('/storage/'.$videos->cover)}}" alt="" class="mx-auto rounded"> 
				    		@else
				    			<img src="data:image/png;base64," alt="" class="mx-auto rounded"> 
				    		@endif
						</div>
...
<div class="bg-gray-100 my-20 h-14 shadow-inner w-full"></div>
...
<div class="pt-8 max-w-6xl mx-auto  px-8 lg:px-0">
	<div>
		<div>
			...
			<div class="grid lg:grid-cols-3  md:grid-cols-2 xs:grid-cols-1 gap-10">
				@foreach(\App\Models\Boletim::orderBy('created_at','desc')->get() as $boletim )
					<div>
