		...
		<div class="md:pr-10 flex-1">
			<div class="sm:mx-auto  sm:px-8 mb-8 lg:px-0 mb-20" style="background: url('/img/bg-banner-saude.png') no-repeat; background-size: cover ;">
				<div class=" max-w-6xl text-3xl font-semibold mb-2 text-left mx-auto pt-6 pb-6 px-4">
					...
					<p class="text-base sm:w-6/12 pl-2 pt-2 border-t-4 border-actionblue text-actionblue mt-2 ">Mural Digital da Saúde.</p>
				</div>
			</div>
							...
							<div class="w-full pt-6 sm:pt-0 sm:w-8/12 sm:px-6 group flex flex-col justify-between">
								...
								<div x-data='{sendMail:false}' class="text-center sm:flex sm:items-center sm:justify-between p-2 rounded sm:space-x-4">
									...
									<div class="flex justify-center sm:justify-end mx-auto">
										...
										@livewire('send-to-mail',['type'=>'health','post_id'=>$news->id,'title'=>$news->title,'short_text'=>$news->short_text])
									</div>
								</div>
							</div>
						</div>
